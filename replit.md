...
- **Cron Scheduler**: Background job scheduler (server/cronScheduler.ts) sends daily 9 AM weekly activity summary emails to subscribed users (Basic, Pro, Lifetime plans) via Postmark. Manual trigger endpoint: `/api/cron/trigger-daily-reports`.
